...
from apps.crawler.spiders.naver_rental_spider import NaverRentalSpider
import logging
...
class Command(BaseCommand):
    help = 'Crawl land.naver.com for 네이버부동산 rental listing data'
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(
            self.style.SUCCESS(f'Starting Naver Rental crawler (pages: {num_pages}, save: {save_data})')
        )
        ...
        try:
            ...
            logger.exception('Naver Rental crawler error')
