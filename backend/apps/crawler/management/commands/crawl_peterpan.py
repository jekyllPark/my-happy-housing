...
from apps.crawler.spiders.peterpan_spider import PeterpanSpider
import logging
...
class Command(BaseCommand):
    help = 'Crawl peterpanz.com for 피터팬 rental listing data'
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(
            self.style.SUCCESS(f'Starting Peterpan crawler (pages: {num_pages}, save: {save_data})')
        )
        ...
        try:
            ...
            logger.exception('Peterpan crawler error')
