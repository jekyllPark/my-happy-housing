...
from apps.crawler.spiders.myhome_spider import MyHomeSpider
import logging
...
class Command(BaseCommand):
    help = 'Crawl myhome.go.kr for housing complex data'
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(
            self.style.SUCCESS(f'Starting MyHome crawler (pages: {num_pages})')
        )
        ...
        try:
            ...
            logger.exception('MyHome crawler error')
